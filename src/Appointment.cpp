...
int Appointment::getId() const { return aid; }
int Appointment::getPid() const { return pid; }
int Appointment::getDid() const { return did; }
const char* Appointment::getDate() const { return date; }
const char* Appointment::getSlot() const { return slot; }
const char* Appointment::getStat() const { return status; }
